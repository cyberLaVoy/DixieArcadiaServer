...
class GamesDB:
    ...
    def createTables(self):
        ...
        gamesTable = "CREATE TABLE IF NOT EXISTS games ( profile_name varchar, description varchar, game_name varchar, last_played integer DEFAULT NULL, plays integer DEFAULT 0, zip varchar, thumbnail varchar);"
